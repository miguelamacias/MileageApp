...
class Adapters {
	class MileageAdapter (val rootView: View)
	...
	class IconAdapter(context: Context, textViewResourceId: Int, private val objects: List<Int>) :
	...
	class ColorAdapter(context: Context, textViewResourceId: Int, private val objects: List<Int>) :
		ArrayAdapter<Int>(context, textViewResourceId, objects) {
